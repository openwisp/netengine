...
The usage of Netengine module requires it to be installed properly as
explained in :doc:`index <../index>`. If you have an installation under a
virtualenv, enter the folder /bin and type:

::

    source activate

otherwise (if you have installed globally) just open an editor as bpython
and you we are ready to go.
...
To invoke methods over the just declared device it's necessary to use the
dot notation as:
