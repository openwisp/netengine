...
class BaseBackend(object):
    ...
    def os(self):
        ...
        should return a tuple in which the first element is the OS name
        and the second element is the OS version
        """
        raise NotImplementedError("Not implemented")
    ...
    def uptime(self):
        ...
        should return an integer representing the number of seconds of
        uptime
        """
        raise NotImplementedError("Not implemented")
